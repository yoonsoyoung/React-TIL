...
CRA 프로젝트 생성과 BEM모델 적용 및 React Router, Context API, useState, useEffect 등의 사용법을 익힌다. Firebase를 이용한 CRUD와 보안, 인증을 적용하여 블로그를 만들고 Firebase CLI로 배포할 수 있다.

### react-twitter-app [📂ing](https://github.com/yoonsoyoung/React-TIL/tree/main/react-twitter-app)

> 고성능 대규모 프론트엔드 10개 프로젝트 - Course 2 (w/패스트캠퍼스)

CRA 프로젝트 생성과 Recoil을 통한 전역 상태 관리 및 다국어 처리를 구현하고, SCSS의 반응형 스타일링을 입힌다. Firebase의 Authentication, OAuth, Firestore, Storage를 이용한 사용자 인증 및 실시간 업데이트를 적용한 트위터를 만들고 Vercel CLI로 배포할 수 있다.
